...
getSplitByGrapheme = function () {
  return getActiveProp('splitByGrapheme');
};
setSplitByGrapheme = function (value) {
...
setPatternStyle = function (value) {
...
maybeLoadShape = function (e) {
  $el = $(e.target).closest('button.shape');
  if (!$el[0]) return;
...
function addImage(imageName, minScale, maxScale) {
  ...
  fabric.Image.fromURL(imageName, function (image) {
    ...
    image.set({
      ...
      .scale(1)// getRandomNum(minScale, maxScale))
      .setCoords();
...
addImage1 = function (url) {
  addImage(url, 0.1, 0.25);
};

addImage2 = function () {
  addImage('download.png', 0.1, 1);
};
...
addImage4 = function () {
  ...
  video1El.addEventListener('loadeddata', function () {
    ...
    coord = getRandomLeftTop();
    video = new fabric.Image(video1El, {
      left: coord.left,
      top: coord.top,
      angle: getRandomInt(-10, 10)
    });
...
rasterize = function (multiplier) {
  if (!fabric.Canvas.supports('toDataURL')) {
    ...
    data = canvas.toDataURL({ multiplier: multiplier, format: 'png' });
...
rasterizeJSON = function () {
  setConsoleJSON(JSON.stringify(canvas));
};
...
getLockScalingFlip = function () {
  return getActiveProp('lockScalingFlip');
};
setLockScalingFlip = function (value) {
...
setCenteredRotation = function (value) {
  setActiveProp('centeredRotation', value);
};

getCenteredRotation = function (value) {
...
setHasBorders = function (value) {
  return setActiveProp('hasBorders', value);
};

getHasControls = function () {
  return getActiveProp('hasControls');
};

setHasControls = function (value) {
...
clip = function () {
  ...
  if (obj.clipTo) {
    ...
    radius = obj.width < obj.height ? (obj.width / 2) : (obj.height / 2);
...
saveJSON = function (withDefaults) {
...
function addTexts() {
  iText = new fabric.IText('lorem ipsum\ndolor\nsit Amet\nconsectetur', {
    left: 100,
    top: 150,
    fontFamily: 'Helvetica',
    fill: '#333',
  ...
  iText2 = new fabric.IText('foo bar\nbaz\nquux', {
    left: 400,
    top: 150,
    fontFamily: 'Helvetica',
    fill: '#333',
...
getPreserveObjectStacking = function () {
  return canvas.preserveObjectStacking;
};
setPreserveObjectStacking = function (value) {
  return canvas.preserveObjectStacking = value;
};

getEnableRetinaScaling = function () {
  return canvas.enableRetinaScaling;
};
setEnableRetinaScaling = function (value) {
...
getSkipOffscreen = function () {
  return canvas.skipOffscreen;
};
setSkipOffscreen = function (value) {
...
function initDiamondPatternBrush() {
  ...
  diamondPatternBrush.getPatternSrc = function () {
    ...
    squareWidth = 10, squareDistance = 5;
    ...
    canvasWidth = rect.getBoundingRect().width;
...
function initSquarePatternBrush() {
  ...
  squarePatternBrush.getPatternSrc = function () {
    ...
    squareWidth = 10, squareDistance = 2;
